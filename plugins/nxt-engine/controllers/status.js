...
module.controller('NxtEngineStatusPlugin', function($scope, serverService, nxt, requests, $interval) {
  ...
  var api           = nxt.nxt();
  var id            = 'TYPE_NXT';
  var genesis_stamp = (new Date(Date.UTC(2013, 10, 24, 12, 0, 0, 0))).getTime();
